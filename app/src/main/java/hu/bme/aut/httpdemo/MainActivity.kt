...
import hu.bme.aut.httpdemo.ui.screen.weather.WeatherApiScreen
import hu.bme.aut.httpdemo.ui.screen.weather.WeatherDetailsScreen
        ...
        composable(Screen.MoneyRatesAPI.route) {
            WeatherApiScreen(
                onCitySelected = { cityWeather ->
                    navController.navigate("weatherDetails/${cityWeather.cityName}")
                }
            )
        }
        composable(
            route = "weatherDetails/{cityName}",
        ) { backStackEntry ->
